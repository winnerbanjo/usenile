...
function seedArticles() {
  ...
  return [
    ...
    },
    {
      ...
      content:
        '<div class="container"><div class="table-of-contents" style="background-color:#f8f9fa;padding:20px;border-radius:8px;margin-bottom:2rem;"><h2 style="margin-top:0;font-size:1.5rem;color:#333;">Table of Contents</h2><ul style="list-style:none;padding-left:0;margin-bottom:0;"><li style="margin-bottom:10px;"><a href="#s1" style="color:#0066cc;text-decoration:none;font-weight:500;">1. How to Add Hero Images</a></li><li style="margin-bottom:10px;"><a href="#s2" style="color:#0066cc;text-decoration:none;font-weight:500;">2. How to Add the Store Logo Image on the Navigation Bar</a></li><li style="margin-bottom:10px;"><a href="#s3" style="color:#0066cc;text-decoration:none;font-weight:500;">3. How to Add Your Social Handles</a></li><li style="margin-bottom:10px;"><a href="#s4" style="color:#0066cc;text-decoration:none;font-weight:500;">4. How to Add Pages to Your Store</a></li><li style="margin-bottom:10px;"><a href="#s5" style="color:#0066cc;text-decoration:none;font-weight:500;">5. How to Setup WhatsApp Floating Button</a></li><li><a href="#s6" style="color:#0066cc;text-decoration:none;font-weight:500;">6. How to Setup Payment Method</a></li></ul></div><section id="s1" style="padding:0;"><h2>How to Add Hero Images</h2><ol><li class="step">Go to <strong>Themes</strong> on the sidebar on the merchant dashboard.</li><img src="/src/assets/theme_theme_icon.png" alt="Add Hero Image" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Open Website Builder</strong> on the bottom right corner of the Theme page.</li><img src="/src/assets/theme_web_builder.png" alt="theme builder icon" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Hero</strong> under Add Section.</li><img src="/src/assets/theme_hero_menu.png" alt="Hero Image Menu" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Add Image</strong> on the right side.</li><img src="/src/assets/theme_add_hero_image.png" alt="Add Hero Image" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Select the image you want to add as your Hero image. The first image will be used as the desktop hero image and as a fallback for mobile. If you add a second image, it becomes the mobile hero image.</li><li class="step">Click on <strong>Publish</strong> to save.</li></ol></section><section id="s2" style="padding:0;"><h2>How to Add the Store Logo Image on the Navigation Bar</h2><ol><li class="step">Click on <strong>Store Information</strong> on the sidebar.</li><img src="/src/assets/theme_store_information_menu.png" alt="store information" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Edit Store Information</strong>.</li><img src="/src/assets/theme_add_store_icon.png" alt="add store icon" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on the image to select the image you want to use as your store logo.</li><li class="step">After the image is uploaded, click <strong>Save Store Settings</strong>.</li></ol></section><section id="s3" style="padding:0;"><h2>How to Add Your Social Handles</h2><ol><li class="step">Click on <strong>Store Information</strong>.</li><img src="/src/assets/theme_store_information_menu.png" alt="store information" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Edit Store Information</strong>.</li><li class="step">Scroll down to the <strong>Social Connections</strong> section.</li><li class="step">Enter your business social media profile links.</li><img src="/src/assets/theme_social_connection.png" alt="social Connections" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Note Only links added here will appear in the website footer.</li><li class="step">Click <strong>Save Store Settings</strong>.</li></ol></section><section id="s4" style="padding:0;"><h2>How to Add Pages to Your Store</h2><ol><li class="step">Click on <strong>Pages</strong> on the sidebar.</li><img src="/src/assets/theme_pages_menu.png" alt="store pages" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click <strong>Add New Page</strong>.</li><img src="/src/assets/theme_add_pages.png" alt="add pages" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Enter the page name and click <strong>Initialize Page Design</strong>.</li><img src="/src/assets/theme_initialize_page_design.png" alt="Initialize Page" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Type the page content and click <strong>Publish Changes</strong>.</li><li class="step">You can create as many pages as needed; they automatically appear in the footer.</li></ol></section><section id="s5" style="padding:0;"><h2>How to Setup WhatsApp Floating Button</h2><ol><li class="step">Click <strong>Store Information</strong>.</li><img src="/src/assets/theme_store_information_menu.png" alt="store information" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Enter a WhatsApp number and save the store settings.</li><img src="/src/assets/theme_whatsapp_number.png" alt="whatsapp number" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Go to <strong>Tools</strong> on the sidebar.</li><img src="/src/assets/theme_tool_menu.png" alt="tool menu" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Open <strong>Storefront Contact</strong> and enable the WhatsApp Floating Button.</li><img src="/src/assets/theme_whatapp_floating_number.png" alt="WhatsApp Floating Icon" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/></ol></section><section id="s6" style="padding:0;"><h2>How to Setup Payment Method</h2><ol><li class="step">Click <strong>Payments</strong> on the sidebar.</li><img src="/src/assets/theme_payment_menu.png" alt="payment menu" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click <strong>Set Payment Method</strong>.</li><img src="/src/assets/theme_configure_payment_method.png" alt="set payment method" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Enable card payments, bank transfers, payment on delivery, or any combination of these methods.</li></ol></section></div>',
      status: "published",
      publishedAt: now,
      createdAt: now,
      updatedAt: now,
...

    {
      ...
      content:
        '<div class="container"><div class="table-of-contents" style="background-color:#f8f9fa;padding:20px;border-radius:8px;margin-bottom:2rem;"><h2 style="margin-top:0;font-size:1.5rem;color:#333;">Table of Contents</h2><ul style="list-style:none;padding-left:0;margin-bottom:0;"><li style="margin-bottom:10px;"><a href="#s1" style="color:#0066cc;text-decoration:none;font-weight:500;">1. How to Add Hero Images</a></li><li style="margin-bottom:10px;"><a href="#s2" style="color:#0066cc;text-decoration:none;font-weight:500;">2. How to Add the Store Logo Image on the Navigation Bar</a></li><li style="margin-bottom:10px;"><a href="#s3" style="color:#0066cc;text-decoration:none;font-weight:500;">3. How to Add Your Social Handles</a></li><li style="margin-bottom:10px;"><a href="#s4" style="color:#0066cc;text-decoration:none;font-weight:500;">4. How to Add Pages to Your Store</a></li><li style="margin-bottom:10px;"><a href="#s5" style="color:#0066cc;text-decoration:none;font-weight:500;">5. How to Setup WhatsApp Floating Button</a></li><li><a href="#s6" style="color:#0066cc;text-decoration:none;font-weight:500;">6. How to Setup Payment Method</a></li></ul></div><section id="s1" style="padding:0;"><h2>How to Add Hero Images</h2><ol><li class="step">Go to <strong>Themes</strong> on the sidebar on the merchant dashboard.</li><img src="/src/assets/theme_theme_icon.png" alt="Add Hero Image" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Open Website Builder</strong> on the bottom right corner of the Theme page.</li><img src="/src/assets/theme_web_builder.png" alt="theme builder icon" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Hero</strong> under Add Section.</li><img src="/src/assets/theme_hero_menu.png" alt="Hero Image Menu" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Add Image</strong> on the right side.</li><img src="/src/assets/theme_add_hero_image.png" alt="Add Hero Image" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Select the image you want to add as your Hero image.</li><li class="step">Click on <strong>Publish</strong> to save.</li></ol></section><section id="s2" style="padding:0;"><h2>How to Add the Store Logo Image on the Navigation Bar</h2><ol><li class="step">Click on <strong>Store Information</strong> on the sidebar.</li><img src="/src/assets/theme_store_information_menu.png" alt="store information" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Edit Store Information</strong>.</li><img src="/src/assets/theme_add_store_icon.png" alt="add store icon" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on the image to select the image you want to use as your store logo.</li><li class="step">After the image is uploaded, click <strong>Save Store Settings</strong>.</li></ol></section><section id="s3" style="padding:0;"><h2>How to Add Your Social Handles</h2><ol><li class="step">Click on <strong>Store Information</strong>.</li><img src="/src/assets/theme_store_information_menu.png" alt="store information" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click on <strong>Edit Store Information</strong>.</li><li class="step">Scroll down to the <strong>Social Connections</strong> section.</li><li class="step">Enter your business social media profile links.</li><img src="/src/assets/theme_social_connection.png" alt="social Connections" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Note Only links added here will appear in the website footer.</li><li class="step">Click <strong>Save Store Settings</strong>.</li></ol></section><section id="s4" style="padding:0;"><h2>How to Add Pages to Your Store</h2><ol><li class="step">Click on <strong>Pages</strong> on the sidebar.</li><img src="/src/assets/theme_pages_menu.png" alt="store pages" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click <strong>Add New Page</strong>.</li><img src="/src/assets/theme_add_pages.png" alt="add pages" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Enter the page name and click <strong>Initialize Page Design</strong>.</li><img src="/src/assets/theme_initialize_page_design.png" alt="Initialize Page" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Type the page content and click <strong>Publish Changes</strong>.</li><li class="step">You can create as many pages as needed; they automatically appear in the footer.</li></ol></section><section id="s5" style="padding:0;"><h2>How to Setup WhatsApp Floating Button</h2><ol><li class="step">Click <strong>Store Information</strong>.</li><img src="/src/assets/theme_store_information_menu.png" alt="store information" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Enter a WhatsApp number and save the store settings.</li><img src="/src/assets/theme_whatsapp_number.png" alt="whatsapp number" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Go to <strong>Tools</strong> on the sidebar.</li><img src="/src/assets/theme_tool_menu.png" alt="tool menu" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Open <strong>Storefront Contact</strong> and enable the WhatsApp Floating Button.</li><img src="/src/assets/theme_whatapp_floating_number.png" alt="WhatsApp Floating Icon" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/></ol></section><section id="s6" style="padding:0;"><h2>How to Setup Payment Method</h2><ol><li class="step">Click <strong>Payments</strong> on the sidebar.</li><img src="/src/assets/theme_payment_menu.png" alt="payment menu" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Click <strong>Set Payment Method</strong>.</li><img src="/src/assets/theme_configure_payment_method.png" alt="set payment method" width="100%" height="400" style="margin-bottom:30px;object-fit:contain"/><li class="step">Enable card payments, bank transfers, payment on delivery, or any combination of these methods.</li></ol></section></div>',
      status: "published",
      publishedAt: now,
      createdAt: now,
      updatedAt: now,
